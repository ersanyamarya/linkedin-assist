...
export const UI = {
	CLASSES: {
		...
		MODAL_TITLE: "linkedin-assist__modal-title",
		MODAL_CONTENT: "linkedin-assist__modal-content",
		MODAL_FORM: "linkedin-assist__modal-form",
		MODAL_SECTION: "linkedin-assist__modal-section",
		MODAL_LABEL: "linkedin-assist__modal-label",
		MODAL_HINT: "linkedin-assist__modal-hint",
		MODAL_INPUT: "linkedin-assist__modal-input",
		MODAL_TEXTAREA: "linkedin-assist__modal-textarea",
		MODAL_SELECT: "linkedin-assist__modal-select",
		MODAL_LIST: "linkedin-assist__modal-list",
		MODAL_CHECKBOX_ROW: "linkedin-assist__modal-checkbox-row",
		MODAL_CHECKBOX: "linkedin-assist__modal-checkbox",
		MODAL_CHECKBOX_TEXT: "linkedin-assist__modal-checkbox-text",
